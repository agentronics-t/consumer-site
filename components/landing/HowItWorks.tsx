      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-16 max-w-2xl">
          ...
          <h2 className="font-display text-4xl font-bold leading-[1.05] tracking-tight text-text-primary md:text-5xl">
            From <span className="font-sans italic text-border-glow">intent</span> to done —
            in three steps.
          </h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {steps.map((s, i) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-border bg-bg-card p-7 card-shadow"
            >
              ...
              <h3 className="mt-5 font-display text-xl font-semibold leading-snug text-text-primary">
                {s.title}
              </h3>
