      ...
      <main className="pt-32">
        <article className="mx-auto max-w-3xl px-6 pb-24">
          ...
          <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-text-secondary">
            <section>
              <h2 className="font-display text-xl font-semibold text-text-primary">1. Acceptance</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-text-primary">2. Acceptable use</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-text-primary">3. Credits and billing</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-text-primary">4. Liability</h2>
              <p className="mt-2">
